...
public class ErrorMessage {
    ...
    public static final String CANT_START = "チームが設定されていません";
    public static final String NO_TEAM_CMD = "チーム名の指定がありません";
    public static final String NO_TEAM_NAME = "チーム「TEAM_NAME」は存在しません";
}
